...
export const INCIDENTS: Incident[] = [
  { name: "Ronin Bridge", date: "2022-03-23", chainKey: 3, target: "0x1A2a1c938CE3eC39b6D47113c7955bAa9DD454F2", kind: 2, token: "USDC", decimals: 6, threshold: 1_000_000n * 10n ** 6n, block: 14_442_840,
  ...
  { name: "Euler Finance", date: "2023-03-13", chainKey: 3, target: "0x27182842E098f60e3D576794A5bFFb0777E025d3", kind: 2, token: "DAI", decimals: 18, threshold: 1_000_000n * E18, block: 16_817_996,
  ...
  { name: "Harmony Horizon Bridge", date: "2022-06-23", chainKey: 3, target: "0x2dCCDB493827E15a5dC8f8b72147E6c4A5620857", kind: 2, token: "DAI", decimals: 18, threshold: 1_000_000n * E18, block: 15_012_677,
  ...
  { name: "Poly Network", date: "2021-08-10", chainKey: 3, target: "0x250e76987d838a75310c34bf422ea9f1AC4Cc906", kind: 2, token: "SHIB", decimals: 18, threshold: 100_000_000_000n * E18, block: 12_996_730,
  ...
  { name: "Nomad Bridge", date: "2022-08-01", chainKey: 3, target: "0x88A69B4E698A4B090DF6CF5Bd7B2D47325Ad30A3", kind: 2, token: "WETH", decimals: 18, threshold: 1_000n * E18, block: 15_259_358,
